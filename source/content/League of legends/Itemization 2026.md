...
- **Percent Penetration (Cryptbloom vs. Void Staff):**
    ...
    - _Note:_ You should often buy percent penetration **preemptively** before the enemy finishes their MR items, or you will find yourself unable to kill anyone to generate gold.
...
| Scenario               | Recommended Build Path                                                           |
| :--------------------- | :------------------------------------------------------------------------------- |
| **Solo AP / Flat Pen** | Blackfire → Sorcs → Shadow Flame → Deathcap → Cryptbloom                         |
| **Vs. Heavy Tanks**    | Blackfire → Sorcs → Cryptbloom (2nd) → Deathcap → Liandry's                      |
| **Duo AP (Standard)**  | Blackfire → CDR Boots → Situational (Actualizer/Horizon) → Deathcap → Cryptbloom |
| **Safety/Scaling**     | Seraph's → Sorcs → Actualizer → Deathcap → Cryptbloom                            |
